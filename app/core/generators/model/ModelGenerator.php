...
namespace app\core\generators\model;
...
class ModelGenerator extends AppGenerator {
    ...
    public $tableName;
    public $modelClass;
    public $baseClass = 'app\core\base\AppModel';
    ...
    public function rules() {
        return array_merge(parent::rules(), [
            ...
            [['generateLabelsFromComments', 'useTablePrefix', 'useSchemaName'], 'boolean'],
            [['enableI18N'], 'boolean'],
    ...
    public function stickyAttributes() {
        return array_merge(parent::stickyAttributes(), ['db', 'baseClass', 'generateRelations', 'generateLabelsFromComments']);
    }
